function Load()
{
  document.getElementById("version").textContent = "20201027";
}
...
function Check()
{
  ...
  if (btoa(encodeURIComponent(document.getElementsByName("as")[0].value)) != 'JUVBJUIwJTkzJUVCJTlEJUJDJUVCJUI5JTg0JUVDJUI5JUI0')
  {
    alert("비밀번호가 틀렸습니다.");
    return;
  }
